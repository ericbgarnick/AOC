"""Brute force solution: part 2 takes a minute or 2 to complete"""
...
def create_pocket_dimension(filename: str) -> PocketDimension:
    ...
    for line in open(filename, "r"):
        ...
        for cube in line.strip():
            if cube == "#":
                pocket_dimension.add((x_dim, y_dim, z_dim, w_dim))
            x_dim += 1
        y_dim += 1
